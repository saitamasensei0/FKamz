...
# Code to generate the Heatmaps showing Organic ranking of Sponsored products (Horizontal)
...
for j in range(len(list_of_names)):
    ...
    result = np.reshape(result, (20, 12))
    result = result.T
