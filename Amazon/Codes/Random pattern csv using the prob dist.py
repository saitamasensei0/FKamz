...
# Code to generate the random pattern csv using the original pattern csv
...
#     df = pd.read_csv("C:/Users/Nikita/Amazon_"+list_of_names[j]+'1.csv')
    ...
    print(frame)
    frame.to_csv("C:/Users/Nikita/Amazon_"+list_of_names[j]+'_after_Prob dist_random.csv')
